...
#if defined(CONFIG_BCM43XX_WEXT)
#include <wl_iw.h>
extern wl_iw_extra_params_t  g_wl_iw_params;
#endif /* defined(CONFIG_BCM43XX_WEXT) */
...
#if defined(SOFTAP) && defined(CONFIG_BCM43XX_WEXT) && !defined(WL_CFG80211)
