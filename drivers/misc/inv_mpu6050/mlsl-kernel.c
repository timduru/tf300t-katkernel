...
int inv_mpu6050_serial_single_write(
	void *sl_handle,
...
EXPORT_SYMBOL(inv_mpu6050_serial_single_write);

int inv_mpu6050_serial_write(
	void *sl_handle,
	unsigned char slave_addr,
...
EXPORT_SYMBOL(inv_mpu6050_serial_write);

int inv_mpu6050_serial_read(
	void *sl_handle,
	unsigned char slave_addr,
	unsigned char register_addr,
	unsigned short length,
...
EXPORT_SYMBOL(inv_mpu6050_serial_read);

int inv_mpu6050_serial_write_mem(
	void *sl_handle,
	unsigned char slave_addr,
	unsigned short mem_addr,
	unsigned short length,
...
EXPORT_SYMBOL(inv_mpu6050_serial_write_mem);

int inv_mpu6050_serial_read_mem(
	void *sl_handle,
	unsigned char slave_addr,
	unsigned short mem_addr,
	unsigned short length,
...
EXPORT_SYMBOL(inv_mpu6050_serial_read_mem);

int inv_mpu6050_serial_write_fifo(
	void *sl_handle,
	unsigned char slave_addr,
	unsigned short length,
	unsigned char const *data)
...
EXPORT_SYMBOL(inv_mpu6050_serial_write_fifo);

int inv_mpu6050_serial_read_fifo(
	void *sl_handle,
	unsigned char slave_addr,
	unsigned short length,
	unsigned char *data)
...
EXPORT_SYMBOL(inv_mpu6050_serial_read_fifo);
