...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("vi",     3, 1, KHZ,        1,      1,      1,      1,      1,       1,  470000,  470000,  470000),
        ...
        CORE_DVFS("vde",    0, 1, KHZ,        1, 247000, 304000, 352000, 400000,  437000,  484000,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
        CORE_DVFS("mpe",    0, 1, KHZ,        1, 247000, 304000, 361000, 408000,  446000,  484000,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
        CORE_DVFS("2d",     0, 1, KHZ,        1, 267000, 304000, 361000, 408000,  446000,  484000,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
        CORE_DVFS("epp",    0, 1, KHZ,        1, 267000, 304000, 361000, 408000,  446000,  484000,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
        CORE_DVFS("3d",     0, 1, KHZ,        1, 267000, 304000, 361000, 408000,  446000,  484000,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
        CORE_DVFS("3d2",    0, 1, KHZ,        1, 267000, 304000, 361000, 408000,  446000,  484000,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
        CORE_DVFS("se",     0, 1, KHZ,        1, 267000, 304000, 361000, 408000,  446000,  484000,  GPU_CLK_DVFS,  GPU_CLK_DVFS),

        CORE_DVFS("vde",    1, 1, KHZ,        1, 247000, 304000, 352000, 400000,  437000,  484000,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
        CORE_DVFS("mpe",    1, 1, KHZ,        1, 247000, 304000, 361000, 408000,  446000,  484000,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
        CORE_DVFS("2d",     1, 1, KHZ,        1, 267000, 304000, 361000, 408000,  446000,  484000,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
        CORE_DVFS("epp",    1, 1, KHZ,        1, 267000, 304000, 361000, 408000,  446000,  484000,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
        CORE_DVFS("3d",     1, 1, KHZ,        1, 247000, 304000, 361000, 408000,  446000,  484000,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
        CORE_DVFS("3d2",    1, 1, KHZ,        1, 247000, 304000, 361000, 408000,  446000,  484000,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
        CORE_DVFS("se",     1, 1, KHZ,        1, 267000, 304000, 361000, 408000,  446000,  484000,  GPU_CLK_DVFS,  GPU_CLK_DVFS),

        CORE_DVFS("vde",    2, 1, KHZ,        1, 247000, 304000, 352000, 400000,  437000,  484000,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
        CORE_DVFS("mpe",    2, 1, KHZ,        1, 247000, 304000, 361000, 408000,  446000,  484000,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
        CORE_DVFS("2d",     2, 1, KHZ,        1, 267000, 304000, 361000, 408000,  446000,  484000,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
        CORE_DVFS("epp",    2, 1, KHZ,        1, 267000, 304000, 361000, 408000,  446000,  484000,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
        CORE_DVFS("3d",     2, 1, KHZ,        1, 247000, 304000, 361000, 408000,  446000,  484000,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
        CORE_DVFS("3d2",    2, 1, KHZ,        1, 247000, 304000, 361000, 408000,  446000,  484000,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
        CORE_DVFS("se",     2, 1, KHZ,        1, 267000, 304000, 361000, 408000,  446000,  484000,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
