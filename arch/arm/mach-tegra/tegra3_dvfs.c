...
int user_mv_table[MAX_DVFS_FREQS] = {
	750, 800, 825, 850, 875, 900, 912, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1165, 1185, 1212, 1237, 1250, 1300, 1350};
#endif
...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("vde",    0, 1, KHZ,   200000, 247000, 304000, 352000, 400000,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
	CORE_DVFS("mpe",    0, 1, KHZ,   200000, 247000, 304000, 361000, 408000,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
	CORE_DVFS("2d",     0, 1, KHZ,   200000, 267000, 304000, 361000, 408000,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
	CORE_DVFS("epp",    0, 1, KHZ,   200000, 267000, 304000, 361000, 408000,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
	CORE_DVFS("3d",     0, 1, KHZ,   200000, 267000, 304000, 361000, 408000,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
	CORE_DVFS("3d2",    0, 1, KHZ,   200000, 267000, 304000, 361000, 408000,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
	CORE_DVFS("se",     0, 1, KHZ,   200000, 267000, 304000, 361000, 408000,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS),

	CORE_DVFS("vde",    1, 1, KHZ,   200000, 247000, 304000, 352000, 400000,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
	CORE_DVFS("mpe",    1, 1, KHZ,   200000, 247000, 304000, 361000, 408000,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
	CORE_DVFS("2d",     1, 1, KHZ,   200000, 267000, 304000, 361000, 408000,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
	CORE_DVFS("epp",    1, 1, KHZ,   200000, 267000, 304000, 361000, 408000,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
	CORE_DVFS("3d",     1, 1, KHZ,   200000, 247000, 304000, 361000, 408000,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
	CORE_DVFS("3d2",    1, 1, KHZ,   200000, 247000, 304000, 361000, 408000,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
	CORE_DVFS("se",     1, 1, KHZ,   200000, 267000, 304000, 361000, 408000,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS),


	CORE_DVFS("vde",    2, 1, KHZ,   200000, 247000, 304000, 352000, 400000,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
	CORE_DVFS("mpe",    2, 1, KHZ,   200000, 247000, 304000, 361000, 408000,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
	CORE_DVFS("2d",     2, 1, KHZ,   200000, 267000, 304000, 361000, 408000,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
	CORE_DVFS("epp",    2, 1, KHZ,   200000, 267000, 304000, 361000, 408000,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
	CORE_DVFS("3d",     2, 1, KHZ,   200000, 247000, 304000, 361000, 408000,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
	CORE_DVFS("3d2",    2, 1, KHZ,   200000, 247000, 304000, 361000, 408000,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
	CORE_DVFS("se",     2, 1, KHZ,   200000, 267000, 304000, 361000, 408000,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS,  GPU_CLK_DVFS),
